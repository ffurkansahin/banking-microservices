package com.furkansahin.accounts.controller;
...
import com.furkansahin.accounts.dto.ErrorResponseDto;
import com.furkansahin.accounts.dto.ResponseDto;
...
@Tag(name = "CRUD REST APIs for Accounts in SahinBank", description = "CRUD REST APIs in SahinBank to Create, Read, Fetch and Delete account details")
@RestController
...
public class AccountsController {
        ...
        @Operation(summary = "Create Account REST API", description = "REST API to create new Customer & Account for SahinBank")
        @ApiResponses({
